          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form method='POST' action="ins_hosp.php">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Hospital id</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                      value=" <?php echo rand(201,745)?>" name='hsp_id'>
                    
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Hospital Name</label>
                      <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Hospital name" name='hsp_name'>
                    </div>
                    <div class="form-group">
